  ...
  componentDidMount() {
    ...
    if (
      ...
      axios
        ...
        .then((response) => {
          this.setState({
            patient: response.data.data.attributes.last_visit_id,
          });
          // console.log(response.data.data.attributes.last_visit_id);
        })
        .catch((error) => {
  ...
  render() {
    ...
    const headCircumferenceCm = (
      <TextField
        ...
        value={this.format(this.state.head_circumference_cm)}
      />
    );
    const headCircumferenceIn = (
      <TextField
        ...
        value={this.format(this.state.head_circumference_in)}
      />
    );
    ...
    const waistCircumferenceCm = (
      <TextField
        ...
        value={this.format(this.state.waist_circumference_cm)}
      />
    );
    const waistCircumferenceIn = (
      <TextField
        ...
        value={this.format(this.state.waist_circumference_in)}
      />
    );
    const temperatureInF = (
      <TextField
        ...
        value={this.format(this.state.temperature_f)}
      />
    );
                  ...
                  <Grid container spacing={1}>
                    ...
                    <CardFooter style={{ float: "right" }}>
                      ...
                      <Button
                        ...
                        to={`/patient_list/${this.props.match.params.id}/${this.props.match.params.type}`}
                      >
                        Cancel
                      </Button>
                    </CardFooter>
